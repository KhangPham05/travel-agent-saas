...
router = APIRouter(prefix="", tags=["amadeus"])
...
@router.get("/amadeus/hotels/by-city")
...
@router.get("/amadeus/activities/by-city", response_model=ActivitiesByCityResponse)
...
@router.get("/amadeus/hotels/offers")
