...
-- 0. Tenants Table (SaaS isolation)
...
('tenant_a', 'Tenant A - Campus Travel', 'Default student travel agency pricing.'),
('tenant_b', 'Tenant B - Budget Backpacker', 'Separate agency catalog with its own negotiated prices.');

-- 1. Seed Users
INSERT INTO Users (Tenant_Id, First_Name, Last_Name, Email, Phone_Number) VALUES
('tenant_a', 'Hoang', 'Pham', 'Hoang.pham@example.com', '555-123-4567'),
('tenant_b', 'Jane', 'Smith', 'jane.smith@email.co.uk', '44-20-7946-0958');
...
('Travel Agent 1', 'agent1@travel.com','999-487-6543');
...
('NYC001', 'Marriott New York', '1535 Broadway', 'New York', 'Marriott', 'greatleave@hc.com');
...
INSERT INTO Bookings (Tenant_Id, User_Id, Agent_Id, Start_Date, End_Date) VALUES
('tenant_a', 1, NULL, '2024-06-01', '2024-06-21'); -- Returns Booking_Id 1

-- Jane Smith (User 2) booked a trip through Global Travel (Agent 1) to LA (10 days).
INSERT INTO Bookings (Tenant_Id, User_Id, Agent_Id, Start_Date, End_Date) VALUES
('tenant_b', 2, 1, '2024-08-15', '2024-08-25'); -- Returns Booking_Id 2
